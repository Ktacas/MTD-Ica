...
<body>
        ...
        <div class="container_header">
                ...
                <nav class="menu">
                    <ul>
                        ...
                        <li><a href="../admin/admin_blog/index.php">Bienvenido <strong><?php echo $_SESSION['user'];?></strong> </a></li>
    ...
    <div class="container">
        ...
        <div class="links">
            <a href="enviar_datos_eventos/admin_eventos_crear.php">Crear Evento</a>
            <a href="visualizacion_datos_eventos/visualizar_eventos.php">Visualizar Evento</a>
        </div>
    </div>
</body>
</html>